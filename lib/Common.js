...
function getPayForm(ordID, money) {
    ...
    var sign = utils.md5(v_amount + v_moneytype + v_oid + v_mid + v_url + v_key).toUpperCase();
    form = fmt.sprintf(form, v_mid, v_oid, v_amount, v_moneytype, v_url, sign);
    return form;
}
